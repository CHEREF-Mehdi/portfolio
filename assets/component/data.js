...
const data = {
  ...
  socialMedia: {
    ...
    youtube: {
      class: "google",
      link:
        "https://www.youtube.com/channel/UCGCwLEG6HikFzHHfDGfrEbA?view_as=subscriber",
  ...
  service: {
    item1: {
      name: "Front End",
      detail: "React, React Native & ElectronJS",
      icon: "fa fa-mobile",
    },
    item2: {
      name: "Back End & Databases",
      detail: "NodeJS & Django/ SQL & NoSQL",
      icon: "fa fa-server",
    },
    item3: {
      name: "DevOps",
      ...
      items: {
        ...
        item1: {
          ...
          content: {
            ...
            item3: {
              describtion:
                "Touchless drawing application. Human skin detection",
              tools: "Python & Opencv.",
              links: [
        ...
        item: {
          ...
          content: {
            item1: {
              describtion:
                "ANN, SVM and deep learning ANN for text Recognition",
      ...
      items: {
        ...
        item5: {
          ...
          content: {
            item1: {
              describtion:
                "Internship R&D : Implementing 2D/3D fractal models under GPU using CUDA (Use the GPU to perform CPU tasks).",
        ...
        item3: {
          ...
          content: {
            item1: {
              describtion:
                "R&D Engineer: Human skin segmentation, hand gesture recognition & melanoma detection system ",
              tools: "Django, JavaScipt, Python, Scikit-learn & Opencv",
              links: [
                "https://drive.google.com/open?id=1CiABiuy2Z7tcFU2Pcc6aF3FDMekP14nn",
              ],
            },
          },
